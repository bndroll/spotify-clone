...
import { createTrack } from '../store/track/asyncActions';
...
export const CreateTrackForm: React.FC<ICreateTrackFormProps> = ({setFormType}) => {
	const dispatch = useAppDispatch();
	const imgRef = useRef<HTMLImageElement | null>(null);
	const {register, handleSubmit, formState: {errors}} = useForm<ICreateTrackForm>({
	...
	const onSubmit = (data: ICreateTrackForm) => {
